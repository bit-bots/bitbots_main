...
First we need to have the current simplified URDF model. To get this look at the documentation of the wolfang_description package :doc:`../piplus_description/index`.
...
.. code-block:: bash
  ...
  python scripts/fix_urdf_for_webots.py ../piplus_description/urdf/robot.urdf webots_robot.urdf
