...
def run_gui():
    ...
    s_alpha = Slider(_ax(0.414), "def depth rel", 0.1, 0.8, valinit=params.alpha)
    s_dbias = Slider(_ax(0.386), "def depth bias", -2.0, 3.0, valinit=params.depth_bias)
    s_dside = Slider(_ax(0.358), "def side", 0.0, 2.0, valinit=params.def_side)
    s_gap = Slider(_ax(0.330), "def side gap", 0.5, 2.0, valinit=params.gap)
    s_gapc = Slider(_ax(0.302), "def side gap @goal", 0.2, 2.0, valinit=params.gap_close)
    s_f = Slider(_ax(0.274), "supp lead", 0.0, 1.0, valinit=params.f)
    ...
    def draw():
        ...
        params.relativ_supp_max_x, params.solo_def_side_gap = s_smax.val, s_dside.val
