...
class ExtrinsicCalibrationBroadcaster : public rclcpp::Node {
 public:
  ExtrinsicCalibrationBroadcaster() : Node("bitbots_extrinsic_calibration") {
    ...
    this->declare_parameter<std::string>("parent_frame", "camera_optical_frame_left_uncalibrated");
    this->declare_parameter<std::string>("child_frame", "zed_left_camera_optical_frame");
