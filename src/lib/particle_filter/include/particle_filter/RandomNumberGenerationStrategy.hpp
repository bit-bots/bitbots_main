#ifndef RANDOMNUMBERGENERATIONSTRATEGY_HPP
#define RANDOMNUMBERGENERATIONSTRATEGY_HPP
...
class RandomNumberGenerationStrategy {
 public:
  ...
  /**
   * Interface for the generation of a uniform distributed random number
   * between min and max.
...
#endif  // RANDOMNUMBERGENERATIONSTRATEGY_HPP
