...
class ObservationHistory:
    ...
    This differs from :class:`bitbots_rl_motion.history_buffer.HistoryBuffer`,
    which saturates itself with the first pushed value instead of starting from
    zeros. That saturating behaviour is what the mjlab policies were trained
    with; HoST expects the zeros, so the two are not interchangeable.
    """
