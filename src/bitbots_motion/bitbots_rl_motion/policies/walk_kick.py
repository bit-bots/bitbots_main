...
ONNX_WALK_MODEL = os.path.join(get_package_share_directory("bitbots_rl_motion"), "models", "wolfgang_walk_ppo.onnx")
ONNX_KICK_MODEL = os.path.join(get_package_share_directory("bitbots_rl_motion"), "models", "wolfgang_kick_ppo.onnx")
