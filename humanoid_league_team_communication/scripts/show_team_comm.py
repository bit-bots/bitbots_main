...
class TeamCommPrinter:
    ...
    def generate_string(self, data: TeamData):
        ...
        lines.append(f"Ball")
        lines.append(f"  x: {round(data.ball_relative.pose.position.x, 3):<4}")
        lines.append(f"  y: {round(data.ball_relative.pose.position.y, 3):<4}")
        lines.append(f"  x_cov: {round(data.ball_relative.covariance[0], 3):<4}")
        lines.append(f"  y_cov: {round(data.ball_relative.covariance[7], 3):<4}")
