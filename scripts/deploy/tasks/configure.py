...
class Configure(AbstractTaskWhichRequiresSudo):
    ...
    def _configure_game_settings(self, connections: Group) -> GroupResult:
        ...
        def _configure_single(connection: Connection) -> Result:
            ...
            cmd = f"cd {self._remote_workspace} && pixi run --environment {self.ENVIRONMENT} python3 {self._remote_workspace}/src/bitbots_misc/bitbots_parameter_blackboard/bitbots_parameter_blackboard/game_settings.py"
