...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--github-org",
        default="bit-bots",
        help="The Github organization which owns the repository containing the target package" " (default: bit-bots)",
    )
    parser.add_argument("--github-repo", required=True, help="The Github repository name containing the target package")
    parser.add_argument(
        "--default-branch",
        default="master",
        help="The default branch of the repository containing the target package" " (default: master)",
    )
    parser.add_argument(
        "--package-name", required=True, help="The name of the package for which a .rdmanifest file should be generated"
    )
    parser.add_argument(
        "--target-dir",
        default=Path(os.getcwd()),
        type=Path,
        help="The directory into which a .rdmanifest file should be generated" " (default: current directory)",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        dest="dependencies",
        default=[],
        help="Rosdep key which the target package depends on. " "Can be specified multiple times",
    )
    parser.add_argument(
        "--force", "-f", action="store_true", default=False, help="Force overwriting an existing .rdmanifest file"
    )
