...
class StudyEvaluation:
    def __init__(self, audio_condition1_data, audio_condition2_data, web_condition1_data, web_condition2_data, quiz_data, logs_list): #logs_list): 
...
if __name__ == "__main__":
    ...
    evaluation = StudyEvaluation(audio_1_condition, audio_2_condition, web_1_condition, web_2_condition, data_raw, dir_list) #dir_list)
    ...
    # x1, x2 = 1, 2
    # y, h, col = 102, 1, 'black'  # adjust y according to your IOS Score scale
    ...
    # x1, x2 = 1, 2
    # y, h, col = 3.2, 0.1, 'black'  # adjust y according to your IOS Score scale
    ...
    # pairs = [(0,1), (2,3), (4,5)]  # index of boxes for each pair
    # for idx1, idx2 in pairs:
    #     # Bottom whiskers
    #     y_whisker1 = bplot9['whiskers'][idx1*2].get_ydata()[1]  # lower whisker of first box
    #     y_whisker2 = bplot9['whiskers'][idx2*2].get_ydata()[1]  # lower whisker of second box
    #     y_base = min(y_whisker1, y_whisker2) - 0.30  # empty space below

    #     # Positions of boxes
    #     x1 = positions[idx1]
    #     x2 = positions[idx2]
    #     h = 0.15  # vertical tick length

    #     # Draw bracket
    #     axs9.plot([x1, x1], [y_base, y_base - h], lw=1, c='black')
    #     axs9.plot([x2, x2], [y_base, y_base - h], lw=1, c='black')
    #     axs9.plot([x1, x2], [y_base - h, y_base - h], lw=1, c='black')
    #     axs9.text((x1 + x2)/2, y_base - h - 0.35, "*", ha='center', va='bottom', color='black', fontsize=10)
    ...
    # pairs = [(0,1), (4,5)]  # index of boxes for each pair
    # for idx1, idx2 in pairs:
    #     # Bottom whiskers
    #     y_whisker1 = bplot10['whiskers'][idx1*2].get_ydata()[1]  # lower whisker of first box
    #     y_whisker2 = bplot10['whiskers'][idx2*2].get_ydata()[1]  # lower whisker of second box
    #     y_base = min(y_whisker1, y_whisker2) - 0.30  # empty space below
    ...
    #     # Draw bracket
    #     axs10.plot([x1, x1], [y_base, y_base - h], lw=1, c='black')
    #     axs10.plot([x2, x2], [y_base, y_base - h], lw=1, c='black')
    #     axs10.plot([x1, x2], [y_base - h, y_base - h], lw=1, c='black')
    #     axs10.text((x1 + x2)/2, y_base - h - 0.35, "*", ha='center', va='bottom', color='black', fontsize=10)

    # axs10.set_yticks(range(1, 10, 1))
    # axs10.set_ylim(0.5, 9)
