...
def make_sequence_string(row):
    rankMotors1 =  row['Ordne Motoren, die die längste Zeit innerhalb eines Fußballspieles bewegt werden, nach oben. [Rank 1]']
    rankMotors2 =  row['Ordne Motoren, die die längste Zeit innerhalb eines Fußballspieles bewegt werden, nach oben. [Rank 2]']
    rankMotors3 =  row['Ordne Motoren, die die längste Zeit innerhalb eines Fußballspieles bewegt werden, nach oben. [Rank 3]']
    ...
    print("Motor sequence:" + motor_string, "Behavior sequence:" + behavoir_string)
    return motor_sequence, behavoir_sequence
