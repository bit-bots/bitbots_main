...
def dxl_compute_checksum(data_blk_ptr, data_blk_size):
    crc_accum = 0
    crc_table = [0x0000, 0x8005, 0x800F, 0x000A, 0x801B, 0x001E, 0x0014, 0x8011, 0x8033, 0x0036, 0x003C, 0x8039, 0x0028,
...
ser = serial.Serial('/dev/ttyACM0', 1000000, timeout=1)  # open serial port
print(ser.name)  # check which port was really used
values = bytearray([0xff, 0xff, 0xfd, 0x00, 0xFE, 0x03, 0x00, 0x01])  # ping broadcast
check = dxl_compute_checksum(values, 8)
print(check.to_bytes(10, byteorder='big'))
#values = values.append(check)
ser.write(values)
