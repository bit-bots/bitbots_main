...
node.get_logger().info(
    "Waiting for "
    + "/foot_pressure_left/set_foot_zero"
    + "/foot_pressure_left/set_foot_scale"
    + "/foot_pressure_right/set_foot_zero"
    + "/foot_pressure_right/set_foot_scale"
)
...
node.get_logger().info(
    "Thank you for your patience. The configuration has been automatically saved by the pressure_converter already"
)
