...
#ifndef BITBOTS_DYNUP_INCLUDE_BITBOTS_DYNUP_DYNAMIC_BALANCING_GOAL_H_
#define BITBOTS_DYNUP_INCLUDE_BITBOTS_DYNUP_DYNAMIC_BALANCING_GOAL_H_
#include <vector>
#include <string>
...
#endif  //BITBOTS_DYNUP_INCLUDE_BITBOTS_DYNUP_DYNAMIC_BALANCING_GOAL_H_
