...
Visualizer::Visualizer(const std::string &base_topic) :
  ...
  spline_publisher_ = node_handle_.advertise<visualization_msgs::msg::MarkerArray>(base_topic_ + "received_goal",
...
void Visualizer::displaySplines(bitbots_splines::PoseSpline splines,
  ...
  //    return;
  visualization_msgs::msg::MarkerArray path = getPath(splines, frame, params_.spline_smoothness);
