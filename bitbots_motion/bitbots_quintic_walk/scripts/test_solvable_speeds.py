...
from bitbots_utils.utils import get_parameters_from_ros_yaml, load_moveit_parameter
...
walk_parameters = get_parameters_from_ros_yaml(
    "walking",
...
try:
    while True:
        current_command_speed = [
            random.uniform(*cmd_vel_current_bounds[0]),
