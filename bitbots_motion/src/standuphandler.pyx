...
cdef class StandupHandler(object):
    ...
    def __init__(self):
        ...
        self.ground_coefficient  = rospy.get_param("/motion/falling/" + robot_type_name + "/boden_koeffizient")

        #Fallanimation laden
        self.falling_motor_degrees_front = rospy.get_param("/motion/falling/" + robot_type_name + "/motor_stellungen_vorne")
        self.falling_motor_degrees_back  = rospy.get_param("/motion/falling/" + robot_type_name + "/motor_stellungen_hinten")
        self.falling_motor_degrees_right = rospy.get_param("/motion/falling/" + robot_type_name + "/motor_stellungen_rechts")
        self.falling_motor_degrees_left  = rospy.get_param("/motion/falling/" + robot_type_name + "/motor_stellungen_links")
        ...
        self.falling_threshold_back      = rospy.get_param("/motion/falling/" + robot_type_name + "/grenzwert_gyro_y_hinten")\
                                           + rospy.get_param("/ZMPConfig/" + robot_type_name + "/HipPitch")
        self.falling_threshold_right     = rospy.get_param("/motion/falling/" + robot_type_name + "/grenzwert_gyro_x_rechts")
        self.falling_threshold_left      = rospy.get_param("/motion/falling/" + robot_type_name + "/grenzwert_gyro_x_links")
