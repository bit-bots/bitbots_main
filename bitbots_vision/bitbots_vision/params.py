...
gen.add("yolo_nms_threshold", float, description="Yolo: Non maximum suppression threshold", min=0.0, max=1.0)
gen.add("yolo_confidence_threshold", float, description="Yolo: confidence threshold", min=0.0, max=1.0)
...
gen.add("line_detector_use_line_points", bool, description="Calculate and publish the line points")
gen.add("line_detector_use_line_mask", bool, description="Calculate and publish the line mask")
gen.add("line_detector_object_remove_grow", float, description="Makes objects like the ball larger before removing them from the mask", min=0, max=10)
