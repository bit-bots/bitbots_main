...
class LoadImages:
    def __init__(self, path, frame="/camera_optical_frame", topic="image_proc", fps=10, loop=False, pgbar=False):
...
if __name__ == "__main__":
    ...
    parser.add_argument("-t", "--topic", help="ROS topic where the images are published to.", default="image_proc",
        dest="topic", type=str)
