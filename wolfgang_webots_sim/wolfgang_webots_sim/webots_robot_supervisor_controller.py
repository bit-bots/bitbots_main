...
class RobotSupervisorController(SupervisorController, RobotController):
    ...
    def __init__(self, ros_node=None, ros_active=False, mode='normal', robot='wolfgang', base_ns='', model_states_active=True, camera_active=True, foot_sensors_active=True):
        """
