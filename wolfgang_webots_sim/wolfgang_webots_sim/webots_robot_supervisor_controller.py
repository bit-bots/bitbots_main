...
class RobotSupervisorController(SupervisorController, RobotController):
    ...
    def __init__(self, ros_active=False, mode='normal', robot='wolfgang', base_ns='', model_states_active=True, camera_active=True):
        """
        ...
        """
        super().__init__(ros_active=ros_active, mode=mode, base_ns=base_ns, model_states_active=model_states_active)
        ...
        RobotController.__init__(self, ros_active=ros_active, robot=robot, robot_node=self.robot_node, base_ns=base_ns, camera_active=camera_active)
