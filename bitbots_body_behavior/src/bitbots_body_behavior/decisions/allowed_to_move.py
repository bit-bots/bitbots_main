    ...
    def perform(self, reevaluate=False):
        ...
        if self.blackboard.gamestate.get_is_penalized() or self.blackboard.gamestate.get_gamestate() == GameState.GAMESTATE_FINISHED:
            ...
            return 'ONLY_HEAD'
                ...
                self.blackboard.gamestate.get_secondary_state_mode() in (GameState.MODE_PREPARATION, GameState.MODE_END):
            return 'ONLY_HEAD'
            ...
            if not self.blackboard.gamestate.has_kickoff() and self.blackboard.gamestate.get_secondary_seconds_remaining() != 0:
                return 'ONLY_HEAD'
            else:
