#include <bitbots_pressure_sensors/pressure_converter.hpp>
...
void PressureConverter::saveYAML() {
  ...
  path_to_yaml = ament_index_cpp::get_package_share_directory("bitbots_pressure_sensors") + "/config/pressure_" +
                 robot_name + ".yaml";
